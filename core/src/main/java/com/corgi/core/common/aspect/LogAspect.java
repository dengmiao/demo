package com.corgi.core.common.aspect;

import com.corgi.core.common.toolkit.UserAgentUtil;
...
public class LogAspect {
     ...
     * 配置 controller 切面
     */
    @Pointcut(value = "execution(* *.corgi.*.*.*(..)) || execution(* *.corgi..*.controller.*.*(..))")
    public void log() {
    ...
    @Pointcut("@annotation(com.corgi.core.common.annotation.Log)")
